...
public class CanYuFragment extends MePaiMaiFragment{

    private int page = 1;
    @Override
    protected void initData() {
        super.initData();
       // CommonApi.getInstance().my_wtbidder(getToken(),page,CanYuFragment.this,LIST);
        getListData(1,this,LIST);
    }

    protected void getListData(int page, BaseFragment f, int requestcoe ) {
        CommonApi.getInstance().my_wtbidder(getToken(),page,f,requestcoe);
    }
