...
public class JingjiDtailAdapter2 extends BaseQuickAdapter<JingJiDetailBean.MallBean,BaseViewHolder> {


    public JingjiDtailAdapter2(int layoutResId) {
        super(layoutResId);
    }

    // T
    @Override
    protected void convert(BaseViewHolder helper,JingJiDetailBean.MallBean item) {
