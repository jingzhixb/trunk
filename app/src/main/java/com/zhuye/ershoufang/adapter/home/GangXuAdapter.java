...
public class GangXuAdapter extends BaseQuickAdapter<CommonBean,BaseViewHolder> {


    public GangXuAdapter(int layoutResId) {
        super(layoutResId);
    }
...
//                .addOnClickListener(R.id.price);
        ...
        helper.setText(R.id.name,item.getRecommand())
        .setText(R.id.price,item.getPrice()+"元/m²")
        .setText(R.id.dizhi,item.getArea_name()+"-"+item.getBusiness_name());
