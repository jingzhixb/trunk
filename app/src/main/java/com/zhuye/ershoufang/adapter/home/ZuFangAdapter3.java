...
public class ZuFangAdapter3 extends BaseMultiItemQuickAdapter<MyMultipleItem<Common3Bean>,BaseViewHolder> {
     ...
     */
    public ZuFangAdapter3(List<MyMultipleItem<Common3Bean>> data) {
        super(data);
