...
public class WenDaAdapter extends BaseQuickAdapter<WenDadetailBean.AnswerBean,BaseViewHolder> {
    ...
    // T
    @Override
    protected void convert(BaseViewHolder helper, WenDadetailBean.AnswerBean item) {
        try {
            ImageView imageView =  helper.getView(R.id.toou);
