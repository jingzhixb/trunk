...
public class MeShouCangFragment3  extends MutiCommonFragment<Common3Bean> {
    ...
    protected void initData() {
        super.initData();
        CommonApi.getInstance().life_cang(getToken(),page,2,MeShouCangFragment3.this,LIST);
    }
    ...
    protected void onLoadmore() {
        CommonApi.getInstance().life_cang(getToken(),++page,2,MeShouCangFragment3.this,LOADMOREBASE);
    }

    @Override
    protected void onRefresh() {
        CommonApi.getInstance().life_cang(getToken(),1,2,MeShouCangFragment3.this,REFRESHBASE);
    }

    @Override
    protected void initView() {
        adapte =  new ZuFangAdapter3(datas);
