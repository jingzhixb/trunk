...
public class MeShouCangFragment2 extends MutiCommonFragment<Common3Bean>{
    ...
    protected void initData() {
        super.initData();
        CommonApi.getInstance().life_cang(getToken(),page,1,MeShouCangFragment2.this,LIST);
    }
    ...
    protected void onLoadmore() {
        CommonApi.getInstance().life_cang(getToken(),++page,1,MeShouCangFragment2.this,LOADMOREBASE);
    }

    @Override
    protected void onRefresh() {
        CommonApi.getInstance().life_cang(getToken(),1,1,MeShouCangFragment2.this,REFRESHBASE);
    }

    @Override
    protected void initView() {
        adapte =  new ErFangAdapter2(datas);
