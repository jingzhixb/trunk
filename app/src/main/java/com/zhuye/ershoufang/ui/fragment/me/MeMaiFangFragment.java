...
public class MeMaiFangFragment extends CommonMeQiTeFragment {
    ...
    protected void initData() {
        ...
        CommonApi.getInstance().wtsell(getToken(),page,2,MeMaiFangFragment.this,LIST,false);
    }
...
//                start(JingMaiDetailActivity.class,position+"");
    ...
    protected void onLoadmore() {
        CommonApi.getInstance().wtsell(getToken(),++page,2,MeMaiFangFragment.this,LOADMOREBASE,true);
    }

    @Override
    protected void onRefresh() {
        CommonApi.getInstance().wtsell(getToken(),1,2,MeMaiFangFragment.this,REFRESHBASE,true);
    }
}
