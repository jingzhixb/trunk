...
public class CommonXieZiFragment2 extends BaseFragment {
...
//                CommonXieZiFragment2.this, LOADMOREBASE);
//    }
//
//    @Override
...
//                "", price1, price2, select1, yonghu, key,
//                CommonXieZiFragment2.this, REFRESHBASE);
//    }
    ...
    protected void initData() {
        ...
        CommonApi.getInstance().xiaji(getQuId(), CommonXieZiFragment2.this, GETDATA, false);

//        adapte = new ShangPuXieAdapter(R.layout.me_paimai_item);
//        CommonApi.getInstance().index(cate_id, getQuId(), page,
//                "", price1, price2, select1, yonghu, key,
//                CommonXieZiFragment2.this, LIST);
    ...
    protected void initListener() {
        ...
        refresh.setOnRefreshLoadmoreListener(new OnRefreshLoadmoreListener() {
            ...
            public void onLoadmore(RefreshLayout refreshlayout) {
                switch (type) {
                    case 0:
                        CommonApi.getInstance().indexnewhouse2(getQuId(), business_id, price1, price2, 3, ++page, null, null
                                , CommonXieZiFragment2.this, MORE);
                        break;
                    case 1:
                        CommonApi.getInstance().index("6", getQuId(), ++page1, business_id, price1
                                , price2, null, null, null,
                                CommonXieZiFragment2.this, MORE1);
                        break;
                    case 2:
                        CommonApi.getInstance().index("12",
                                getQuId(), ++page2, business_id, price1
                                , price2, null, null, null,
                                CommonXieZiFragment2.this, MORE2);
                        break;
                }
            }
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                switch (type) {
                    case 0:
                        CommonApi.getInstance().indexnewhouse2(getQuId(), business_id, price1, price2, 3, 1, null, null
                                , CommonXieZiFragment2.this, SHUAXIN);
                        break;
                    case 1:
                        CommonApi.getInstance().index("6", getQuId(), 1, business_id, price1
                                , price2, null, null, null,
                                CommonXieZiFragment2.this, SHUAXIN1);
                        break;
                    case 2:
                        CommonApi.getInstance().index("12",
                                getQuId(), 1, business_id, price1
                                , price2, null, null, null,
                                CommonXieZiFragment2.this, SHUAXIN2);
                        break;
                }
            }
        });
