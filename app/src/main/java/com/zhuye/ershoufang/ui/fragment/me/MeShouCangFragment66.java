...
public class MeShouCangFragment66 extends CommonFragment<ZhuangxiuJiaJuBean>{
    ...
    protected void onLoadmore() {
        CommonApi.getInstance().shop_collect(getToken(),++page,2,MeShouCangFragment66.this, LOADMOREBASE);
    }

    @Override
    protected void onRefresh() {
        CommonApi.getInstance().shop_collect(getToken(),1,2,MeShouCangFragment66.this, REFRESHBASE);
    }
    ...
    protected void initData() {
        super.initData();
        CommonApi.getInstance().shop_collect(getToken(),page,2,MeShouCangFragment66.this, LIST);
    }
