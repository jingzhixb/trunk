...
public class MeQiTe6Fragment6 extends CommonMeQiTeFragment<QiTeBean> {
    ...
    protected void initData() {
      ...
      // CommonApi.getInstance().wdaikuan(getToken(),page,6,MeQiTe6Fragment6.this,LIST, false);
        CommonApi.getInstance().daikuan(1,getQuId(),"6",this,LIST, false);
    }
        ...
        adapte.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                if(getToken()==null){
                    ...
                    CommonApi.getInstance().jiedan(getToken(),list.get(position).getLife_id(),MeQiTe6Fragment6.this,JIEDANCODE,true);
                }
            }
        });
    }
    ...
    protected void onLoadmore() {
        //CommonApi.getInstance().wdaikuan(getToken(),++page,6,MeQiTe6Fragment6.this,LOADMOREBASE, true);
        CommonApi.getInstance().daikuan(++page,getQuId(),"6",this,LOADMOREBASE, true);
    }

    @Override
    protected void onRefresh() {
       // CommonApi.getInstance().wdaikuan(getToken(),1,6,MeQiTe6Fragment6.this,REFRESHBASE, true);
        CommonApi.getInstance().daikuan(1,getQuId(),"6",this,REFRESHBASE, true);
    }
}
