...
import com.zhuye.ershoufang.adapter.me.TuiJianViewAdapter3;
...
public class TuiJianViewFragment3 extends TuiJianViewFragment<Common3Bean> {
    ...
    protected void shuaxin(int position) {
        ...
        CommonApi.getInstance().index("4",getQuId(),1,business_id,prce1,prce2,select1,yonghu,"","1",
                TuiJianViewFragment3.this,LIST,false);
    }

    @Override
    protected void initData() {
        super.initData();
        CommonApi.getInstance().index("4",getQuId(),page,business_id,prce1,prce2,select1,yonghu,"","1",
                TuiJianViewFragment3.this,LIST,false);
    }
    ...
    protected void getClickPrice(String prce1, String prce2) {
        CommonApi.getInstance().index("4",getQuId(),page,business_id,prce1,prce2,select1,yonghu,"","1",
                TuiJianViewFragment3.this,LIST,true);
    }
    ...
    protected void initView() {
        adapte = new TuiJianViewAdapter3(R.layout.home_xinfang_item);
    ...
    protected void onLoadmore() {
        CommonApi.getInstance().index("4",getQuId(),++page,business_id,prce1,prce2,select1,yonghu,"","1",
                TuiJianViewFragment3.this,LOADMOREBASE,true);
    }

    @Override
    protected void onRefresh() {
        CommonApi.getInstance().index("4",getQuId(),1,business_id,prce1,prce2,select1,yonghu,"","1",
                TuiJianViewFragment3.this,REFRESHBASE,true);
    }
