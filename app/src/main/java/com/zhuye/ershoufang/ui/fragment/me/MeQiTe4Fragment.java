...
public class MeQiTe4Fragment extends CommonMeQiTeFragment {
    ...
    protected void initData() {
        super.initData();
        adapte = new QiTe4Adapter(R.layout.qite4);
        recycle.setAdapter(adapte);
        // TODO: 2018/3/23 0023       有bug
        recycle.setLayoutManager(new LinearLayoutManager(getActivity()));
        CommonApi.getInstance().wdaikuan(getToken(),page,5,MeQiTe4Fragment.this,LIST,false);
    }
    ...
    protected void onLoadmore() {
        CommonApi.getInstance().wdaikuan(getToken(),++page,5,MeQiTe4Fragment.this,LOADMOREBASE,true);
    }

    @Override
    protected void onRefresh() {
        CommonApi.getInstance().wdaikuan(getToken(),1,5,MeQiTe4Fragment.this,REFRESHBASE,true);
    }
}
