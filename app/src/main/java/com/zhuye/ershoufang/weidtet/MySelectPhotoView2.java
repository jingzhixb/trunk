...
public class MySelectPhotoView2 extends LinearLayout {
    public int REQUESTCODE = 100 ;

    public MySelectPhotoView2(Context context) {
        this(context,null);
    }

    public MySelectPhotoView2(Context context, @Nullable AttributeSet attrs) {
   ...
   public   ImageAdapter2 adapter2;
    ...
    public MySelectPhotoView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
